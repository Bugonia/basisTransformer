...
BASE_RUN="${BASE_RUN:-enwik8_sequence_mixers_fla_muon_8l_512d_ctx512_bs256_lr2e3_test005_100k_earlystop10_lrdecay30k}"
...
"$PYTHON_BIN" experiments/sequence_mixers/summarize_sequence_mixers.py \
...
"$PYTHON_BIN" plot_results_svg.py \
  ...
  "$standard_pattern" \
  --baseline standard \
  --title "Linear Attention and SSM Mixers" \
